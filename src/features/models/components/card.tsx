...
export const ModelCard = ({item, themeColors}:ModelCardProps) => {
    ...
    return(
        <View style={{margin:8,}}>
            ...
            <View style={{position:'absolute', flexDirection:'row', padding:5, borderTopRightRadius:12, borderBottomLeftRadius:12, right:0, top:0, backgroundColor: themeColors.primaryContainer}}>
                
                <Text style={{color:themeColors.onPrimaryContainer}}>{item.stats.downloadCount}</Text>
            </View>
