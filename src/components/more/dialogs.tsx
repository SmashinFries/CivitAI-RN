        ...
        <Dialog visible={visible} onDismiss={onDismiss}>
            ...
            <Dialog.Content>
                <RadioButton.Group onValueChange={value => setSelectedValue(value)} value={selectedValue}>
                    <RadioButton.Item label={`${CivitAiNSFW.None} (Safe)`} value={CivitAiNSFW.None} />
                    <RadioButton.Item label={`${CivitAiNSFW.Soft} (13+)`} value={CivitAiNSFW.Soft} />
                    <RadioButton.Item label={`${CivitAiNSFW.Mature} (17+)`} value={CivitAiNSFW.Mature} />
