...
export const HasMetaDataTag = ({hasMeta}:{hasMeta:boolean}) => {
    if (!hasMeta) return null;
    return(
        <View style={{position:'absolute', borderRadius:12, bottom:0, right:10, padding:10}}>
            <Icon name='information-outline' size={24} color={MD3DarkTheme.colors.onBackground} />
        </View>
    );
};